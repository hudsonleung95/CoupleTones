...
@LargeTest
public class ArrivalDepartureTest {
    ParseClient pctest;
    ...
    public void testArrival() {
        platest = hActivityRule.launchActivity(new Intent());
        context = platest.getApplicationContext();
        //Intents.init();
        //onView(withId(android.R.id.button1)).perform(click());
        pctest = new ParseClient(context);
        LatLng testlatlng = new LatLng(33.945284, -118.401364);
          pctest.sendNotification("Partner Arrived", true,
                "LAX Terminal #1 Upper Level Shuttle Stop", testlatlng);
